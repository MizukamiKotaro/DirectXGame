...
public:
	...
	static Matrix3x3
	    MakeAffineTransformMatrix(const Vector2& scale, float radian, const Vector2& translate);
	...
	static Matrix3x3 MakeWvpVpMatrix(
	    ...
	    const Vector2& orthoTopLeft, const Vector2& orthoBottomRight,
	    const Vector2& viewportTopLeft, const Vector2& viewportBottomRight);
